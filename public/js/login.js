...
function showNewUser() {
    ...
    $('#fnamelabel').css('display', 'block');
    $('#lname').css('display', 'block');
    $('#lnamelabel').css('display', 'block');
    $('#positionlabel').css('display', 'block');
    $('#position').css('display', 'block');
    $('#submit').attr('class', '');
    $('#newuser').attr('class', 'button-primary');
}
...
// Create new user or switch forms
$(document).ready(function() {
    $("#newuser").click(function() {
        if (currentForm == "newuser") {
            var username = $("#username").val();
            var password = md5($("#password").val());
            var fname = $("#fname").val();
            var lname = $("#lname").val();
